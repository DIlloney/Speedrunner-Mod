...
class StructureOptionsScreen {
    ...
    protected static ConfigBuilder openWarningScreen() {
        ...
        structureoptions.addEntry(entryBuilder.startTextDescription(new LiteralText("You need to turn ON Make Structures More Common before modifying the structure generation!")).build());
        return builder;
    }
    ...
    protected static ConfigBuilder openOldStructuresWarningScreen() {
        ...
        structureoptions.addEntry(entryBuilder.startTextDescription(new LiteralText("Your structure settings already match the old settings! No need to change them again...")).build());
        return builder;
    }
