    ...
    public static void applyFog(Camera camera, BackgroundRenderer.FogType fogType, float viewDistance, boolean thickFog) {
        ...
        if (cameraSubmersionType == CameraSubmersionType.WATER) {
            ...
            if (cameraSubmersionType == CameraSubmersionType.LAVA) {
                ...
                } else if (entity instanceof LivingEntity && ((LivingEntity)entity).hasStatusEffect(StatusEffects.FIRE_RESISTANCE) || entity instanceof LivingEntity && ((LivingEntity)entity).hasStatusEffect(StatusEffects.NIGHT_VISION)) {
                    y = 0.0F;
                    ab = 25.0F;
                } else {
                    y = 0.25F;
