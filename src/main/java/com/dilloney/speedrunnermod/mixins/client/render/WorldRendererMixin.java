    ...
    public void processWorldEvent(PlayerEntity source, int eventId, BlockPos pos, int data) {
        ...
        switch(eventId) {
            ...
            case 1032:
                ...
                if (SpeedrunnerMod.CONFIG.customMusic && SpeedrunnerMod.CONFIG.doomMode) {
                    this.client.getSoundManager().play(PositionedSoundInstance.ambient(ModSoundEvents.DOOM_MODE_END_AMBIENT, random.nextFloat() * 0.4F + 0.8F, 0.50F));
                }
                break;
            case 1033:
