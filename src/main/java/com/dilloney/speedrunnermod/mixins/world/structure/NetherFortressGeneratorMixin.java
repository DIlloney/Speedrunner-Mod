...
public class NetherFortressGeneratorMixin {
    ...
    static {
        if (OPTIONS.getModDifficulty() == 1 && OPTIONS.modifiedWorldGeneration || OPTIONS.getModDifficulty() == 2 && OPTIONS.modifiedWorldGeneration) {
        ...
        } else if (OPTIONS.getModDifficulty() == 3 && OPTIONS.modifiedWorldGeneration || OPTIONS.getModDifficulty() == 4 && OPTIONS.modifiedWorldGeneration) {
