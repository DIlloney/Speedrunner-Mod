...
public class SmallFireballEntityMixin extends AbstractFireballEntity {
    ...
    protected SmallFireballEntityMixin(EntityType<? extends AbstractFireballEntity> entityType, World world) {
        super(entityType, world);
    }

    /**
     * Changes how much damage a small fireball entity can do.
     * @author Dilloney
     * @reason
     */
    @Overwrite
    public void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (!this.world.isClient) {
            ...
            if (!entity.isFireImmune()) {
                ...
                } else if (SpeedrunnerMod.OPTIONS.getModDifficulty() <= 2) {
                ...
                } else if (SpeedrunnerMod.OPTIONS.getModDifficulty() == 3) {
                ...
                } else if (SpeedrunnerMod.OPTIONS.getModDifficulty() == 4) {
                    entity.setOnFireFor(6);
