        ...
        if (this.phaseManager.getCurrent().getType() == PhaseType.DYING) {
            ...
            if (amount < 0.01F) {
                ...
                if (source.getAttacker() instanceof PlayerEntity || source.isExplosive()) {
                    ...
                    if (this.phaseManager.getCurrent().isSittingOrHovering() && SpeedrunnerMod.CONFIG.enableChallengeMode) {
                    ...
                    } else if (this.phaseManager.getCurrent().isSittingOrHovering() && SpeedrunnerMod.CONFIG.difficulty == 1) {
                        this.damageDuringSitting = (int)((float)this.damageDuringSitting + (f - this.getHealth()));
