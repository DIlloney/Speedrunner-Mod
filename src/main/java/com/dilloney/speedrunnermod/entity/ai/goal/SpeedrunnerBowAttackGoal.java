...
public class SpeedrunnerBowAttackGoal<T extends HostileEntity & RangedAttackMob> extends Goal {
    ...
    public SpeedrunnerBowAttackGoal(T actor, double speed, int attackInterval, float range) {
        this.actor = actor;
        this.speed = speed;
    ...
    public void tick() {
        ...
        if (livingEntity != null) {
            ...
            if (this.actor.isUsingItem()) {
                ...
                this.actor.setCurrentHand(ProjectileUtil.getHandPossiblyHolding(this.actor, ModItems.SPEEDRUNNER_BOW));
            }
        }
    }
}