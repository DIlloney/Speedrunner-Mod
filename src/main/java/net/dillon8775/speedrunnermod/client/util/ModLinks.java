...
public class ModLinks {
    ...
    public static final String SODIUM_MOD_LINK = "https://modrinth.com/mod/sodium/versions?g=1.18.1";
    public static final String LITHIUM_MOD_LINK = "https://modrinth.com/mod/lithium/versions?g=1.18.1";
    public static final String PHOSPHOR_MOD_LINK = "https://modrinth.com/mod/phosphor/versions?g=1.18.1";
    public static final String SPEEDRUN_IGT_MOD_LINK = "https://modrinth.com/mod/speedrunigt/versions?g=1.18.1";
    public static final String LAZYDFU_MOD_LINK = "https://modrinth.com/mod/lazydfu/versions?g=1.18.1";
    public static final String KRYPTON_MOD_LINK = "https://modrinth.com/mod/krypton/versions?g=1.18.1";
}