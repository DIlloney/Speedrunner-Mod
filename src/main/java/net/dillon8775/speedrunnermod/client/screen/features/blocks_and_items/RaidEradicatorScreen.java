...
public class RaidEradicatorScreen extends AbstractFeatureScreen {
    ...
    public RaidEradicatorScreen(Screen parent, GameOptions options) {
        super(parent, options, new TranslatableText("speedrunnermod.title.features.blocks_and_items.raid_eradicator").formatted(Formatting.LIGHT_PURPLE), 14, true, true);
    }
