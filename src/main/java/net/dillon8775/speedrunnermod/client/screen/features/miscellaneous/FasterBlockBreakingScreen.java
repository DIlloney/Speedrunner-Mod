...
public class FasterBlockBreakingScreen extends GameOptionsScreen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.faster_block_breaking.line1"), this.width / 2, SpeedrunnerModClient.TRIPLE_LINED_SCREEN_LINE_1, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.faster_block_breaking.line2"), this.width / 2, SpeedrunnerModClient.TRIPLE_LINED_SCREEN_LINE_2, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.faster_block_breaking.line3"), this.width / 2, SpeedrunnerModClient.TRIPLE_LINED_SCREEN_LINE_3, 16777215);
