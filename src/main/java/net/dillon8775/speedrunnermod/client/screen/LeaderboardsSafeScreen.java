...
public class LeaderboardsSafeScreen extends AbstractModScreen {
    ...
    protected void init() {
        ...
        }, (button, matrices, x, y) -> this.renderOrderedTooltip(matrices, this.client.textRenderer.wrapLines(new TranslatableText("speedrunnermod.fix_and_restart.tooltip"), 200), x, y)));
        ...
        }, (button, matrices, x, y) -> this.renderOrderedTooltip(matrices, this.client.textRenderer.wrapLines(new TranslatableText("speedrunnermod.ignore.tooltip"), 200), x, y)));
    ...
    public void renderCustomText(MatrixStack matrices) {
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.ineligible_options.line1"), this.width / 2, 80, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.ineligible_options.line2"), this.width / 2, 100, 16777215);
