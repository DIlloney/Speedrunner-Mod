...
import net.dillon8775.speedrunnermod.client.screen.ResetOptionsConfirmScreen;
...
public class ModOptionsScreen extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(leftSide, height, 150, 20, ModTexts.MENU_OPTIONS_MAIN, (buttonWidget) -> {
            this.client.setScreen(new MainOptionsScreen(this.parent, MinecraftClient.getInstance().options));
        }));
        this.addDrawableChild(new ButtonWidget(rightSide, height, 150, 20, ModTexts.MENU_OPTIONS_FAST_WORLD_CREATION, (buttonWidget) -> {
            this.client.setScreen(new FastWorldCreationOptionsScreen(this.parent, MinecraftClient.getInstance().options));
        }));

        height += 24;
        this.addDrawableChild(new ButtonWidget(leftSide, height, 150, 20, ModTexts.MENU_OPTIONS_WORLD_GENERATION, (buttonWidget) -> {
            this.client.setScreen(new WorldGenerationOptionsScreen(this.parent, MinecraftClient.getInstance().options));
        }));
        this.addDrawableChild(new ButtonWidget(rightSide, height, 150, 20, ModTexts.MENU_OPTIONS_CLIENT, (buttonWidget) -> {
            this.client.setScreen(new ClientOptionsScreen(this.parent, MinecraftClient.getInstance().options));
        }));

        height += 24;
        this.addDrawableChild(new ButtonWidget(leftSide, height, 150, 20, ModTexts.MENU_OPTIONS_MISCELLANEOUS, (buttonWidget) -> {
            this.client.setScreen(new MiscellaneousOptionsScreen(this.parent, MinecraftClient.getInstance().options));
        }));
        this.addDrawableChild(new ButtonWidget(rightSide, height, 150, 20, ModTexts.MENU_OPTIONS_ALL, (buttonWidget) -> {
            this.client.setScreen(new AllOptionsScreen(this.parent, MinecraftClient.getInstance().options));
        }));

        height += 24;
        this.addDrawableChild(new ButtonWidget(leftSide, height, 150, 20, ModTexts.MENU_OPTIONS_RESET, (buttonWidget) -> {
            this.client.setScreen(new ResetOptionsConfirmScreen(this.parent, MinecraftClient.getInstance().options));
        }));
        this.addDrawableChild(new ButtonWidget(rightSide, height, 150, 20, ModTexts.MENU_OPEN_OPTIONS_DIRECTORY, (buttonWidget) -> {
