...
public class PiglinPorkScreen extends GameOptionsScreen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.piglin_pork.line1"), this.width / 2, SpeedrunnerModClient.DOUBLE_LINED_SCREEN_LINE_1, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.piglin_pork.line2"), this.width / 2, SpeedrunnerModClient.DOUBLE_LINED_SCREEN_LINE_2, 16777215);
