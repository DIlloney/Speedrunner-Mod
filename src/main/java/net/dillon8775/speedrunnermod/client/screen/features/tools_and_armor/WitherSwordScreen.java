...
public class WitherSwordScreen extends AbstractFeatureScreen {
    ...
    public WitherSwordScreen(Screen parent, GameOptions options) {
        super(parent, options, new TranslatableText("speedrunnermod.title.features.tools_and_armor.wither_sword").formatted(Formatting.GRAY), 6, true, true, new SpeedrunnersWastelandBiomeScreen(parent, options), new TranslatableText("speedrunnermod.menu.features.ores_and_worldgen"), new ResetKeyScreen(parent, options), new TranslatableText("speedrunnermod.menu.features.miscellaneous"), new SpeedrunnerIngotsScreen(parent, options), new TranslatableText("speedrunnermod.menu.features.blocks_and_items"), false, null, null);
    }
