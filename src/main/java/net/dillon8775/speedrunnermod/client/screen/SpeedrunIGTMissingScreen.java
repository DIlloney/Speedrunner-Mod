...
public class SpeedrunIGTMissingScreen extends AbstractModScreen {
    ...
    protected void init() {
        ...
        }, (button, matrices, x, y) -> this.renderOrderedTooltip(matrices, this.client.textRenderer.wrapLines(Text.translatable("speedrunnermod.download_and_install.tooltip"), 200), x, y)));
