...
public class SpeedrunnerArmorScreen extends AbstractFeatureScreen {
    ...
    public SpeedrunnerArmorScreen(Screen parent, GameOptions options) {
        super(parent, options, new TranslatableText("speedrunnermod.title.features.tools_and_armor.speedrunner_armor").formatted(Formatting.AQUA), 1, true, false);
    }
    ...
    protected void renderCustomImage(MatrixStack matrices) {
        RenderSystem.setShaderTexture(0, new Identifier("speedrunnermod:textures/gui/screens/speedrunner_armor.png"));
