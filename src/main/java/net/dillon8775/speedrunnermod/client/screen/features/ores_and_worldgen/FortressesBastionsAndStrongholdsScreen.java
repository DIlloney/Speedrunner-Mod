...
public class FortressesBastionsAndStrongholdsScreen extends GameOptionsScreen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.fortresses_bastions_and_strongholds.line1"), this.width / 2, SpeedrunnerModClient.QUADRUPLE_LINED_SCREEN_LINE_1, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.fortresses_bastions_and_strongholds.line2"), this.width / 2, SpeedrunnerModClient.QUADRUPLE_LINED_SCREEN_LINE_2, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.fortresses_bastions_and_strongholds.line3"), this.width / 2, SpeedrunnerModClient.QUADRUPLE_LINED_SCREEN_LINE_3, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.fortresses_bastions_and_strongholds.line4"), this.width / 2, SpeedrunnerModClient.QUADRUPLE_LINED_SCREEN_LINE_4, 16777215);
