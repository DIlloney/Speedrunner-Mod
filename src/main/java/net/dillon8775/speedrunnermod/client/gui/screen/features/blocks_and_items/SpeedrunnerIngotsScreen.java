...
public class SpeedrunnerIngotsScreen extends GameOptionsScreen {
    private final Screen parent;
    protected final LiteralText pageNumber = new LiteralText("§lPage:§r 1/12");

    public SpeedrunnerIngotsScreen(Screen parent, GameOptions options) {
        super(parent, options, new TranslatableText("speedrunnermod.title.features.blocks_and_items.speedrunner_ingots"));
        this.parent = parent;
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.blocks_and_items.speedrunner_ingots.line1"), this.width / 2, SpeedrunnerModClient.TRIPLE_LINED_SCREEN_LINE_1, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.blocks_and_items.speedrunner_ingots.line2"), this.width / 2, SpeedrunnerModClient.TRIPLE_LINED_SCREEN_LINE_2, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.blocks_and_items.speedrunner_ingots.line3"), this.width / 2, SpeedrunnerModClient.TRIPLE_LINED_SCREEN_LINE_3, 16777215);
