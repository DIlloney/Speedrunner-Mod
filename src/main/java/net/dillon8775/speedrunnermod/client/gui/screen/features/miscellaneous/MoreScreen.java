...
public class MoreScreen extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(farLeftSide, height, 150, 20, new TranslatableText("speedrunnermod.menu.features.more"), (buttonWidget) -> {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.more.line1"), this.width / 2, 90, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.more.line2"), this.width / 2, 110, 16777215);
        ...
        RenderSystem.setShaderTexture(0, new Identifier("speedrunnermod:textures/gui/features/miscellaneous/more.png"));
