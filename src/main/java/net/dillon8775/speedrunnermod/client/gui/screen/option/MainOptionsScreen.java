...
public class MainOptionsScreen extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        this.list.addSingleOptionEntry(ModOption.STRUCTURE_SPAWN_RATE);
        this.list.addSingleOptionEntry(ModOption.FASTER_BLOCK_BREAKING);
    ...
    static {
        OPTIONS = new Option[]{ModOption.BETTER_BIOMES, ModOption.ICARUS_MODE, ModOption.FOG, ModOption.INFINITY_PEARL_MODE, ModOption.ITEM_TOOLTIPS, ModOption.DOOM_MODE, ModOption.DRAGON_PERCH_TIME, ModOption.STRONGHOLD_COUNT, ModOption.KILL_GHAST_ON_FIREBALL, ModOption.FIREPROOF_ITEMS};
    }
}