...
public class PiglinPorkScreen extends GameOptionsScreen {
    private final Screen parent;
    protected final LiteralText pageNumber = new LiteralText("§lPage:§r 7/10");

    public PiglinPorkScreen(Screen parent, GameOptions options) {
        super(parent, options, new TranslatableText("speedrunnermod.title.features.miscellaneous.piglin_pork"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(farRightSide, height, 150, 20, ModScreenTexts.NEXT, (buttonWidget) -> {
            this.client.setScreen(new NoMorePiglinBrutesScreen(this.parent, MinecraftClient.getInstance().options));
        }));
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.piglin_pork.line1"), this.width / 2, 90, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.piglin_pork.line2"), this.width / 2, 110, 16777215);
        ...
        RenderSystem.setShaderTexture(0, new Identifier("speedrunnermod:textures/gui/features/miscellaneous/piglin_pork.png"));
