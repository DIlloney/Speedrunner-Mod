...
public class SpeedrunnerOresScreen extends GameOptionsScreen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.speedrunner_ores.line1"), this.width / 2, 80, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.speedrunner_ores.line2"), this.width / 2, 100, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.speedrunner_ores.line3"), this.width / 2, 120, 16777215);
        ...
        RenderSystem.setShaderTexture(0, new Identifier("speedrunnermod:textures/gui/features/ores_and_worldgen/speedrunner_ores.png"));
