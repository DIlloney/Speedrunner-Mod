...
public class ModListOptions {
    ...
    protected static final CyclingOption<Boolean> FAST_WORLD_CREATION =
            ...
            SpeedrunnerModClient.clOptions().worldSettings.fastWorldCreation, (gameOptions, option, newValue) ->
            SpeedrunnerModClient.clOptions().worldSettings.fastWorldCreation = newValue);
    ...
    protected static final CyclingOption<CLModOptions.GameMode> GAMEMODE =
            ...
            SpeedrunnerModClient.clOptions().worldSettings.gameMode, (gameOptions, option, gameMode) ->
            SpeedrunnerModClient.clOptions().worldSettings.gameMode = gameMode);
    ...
    protected static final CyclingOption<CLModOptions.Difficulty> DIFFICULTY =
            ...
            SpeedrunnerModClient.clOptions().worldSettings.difficulty, (gameOptions, option, difficulty) ->
            SpeedrunnerModClient.clOptions().worldSettings.difficulty = difficulty);
    ...
    protected static final CyclingOption<Boolean> ALLOW_CHEATS =
            ...
            SpeedrunnerModClient.clOptions().worldSettings.allowCheats, (gameOptions, option, newValue) ->
            SpeedrunnerModClient.clOptions().worldSettings.allowCheats = newValue);
    ...
    protected static final CyclingOption<CLModOptions.Panorama> PANORAMA =
            CyclingOption.create("speedrunnermod.options.panorama",
                            CLModOptions.Panorama.values(), (panorama) ->
                                    new TranslatableText(panorama.getTranslationKey()), (gameOptions) ->
                                    SpeedrunnerModClient.clOptions().panorama, (gameOptions, option, panorama) ->
                                    SpeedrunnerModClient.clOptions().panorama = panorama)
