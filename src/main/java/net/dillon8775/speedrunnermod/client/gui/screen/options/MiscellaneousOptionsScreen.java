...
public class MiscellaneousOptionsScreen extends GameOptionsScreen {
    ...
    public MiscellaneousOptionsScreen(Screen parent, GameOptions options) {
        super(parent, options, new TranslatableText("speedrunnermod.title.options.advanced.miscellaneous"));
        this.parent = parent;
    }
    ...
    static {
        OPTIONS = new Option[]{
                ModListOptions.ALLOW_BOATS_IN_LAVA,
                ModListOptions.ALLOW_WATER_IN_NETHER,
                ...
                ModListOptions.PLAYER_BREATH_TIME,
                ModListOptions.CATCH_BREATH_TIME,
