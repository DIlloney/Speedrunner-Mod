...
public class RestartRequiredScreen extends GameOptionsScreen {
    ...
    public static CLModOptions.Panorama currentPanorama;
    ...
    public static void getCurrentOptions() {
        ...
        currentPanorama = SpeedrunnerModClient.clOptions().panorama;
    }
    ...
    private static void revertChanges() {
        ...
        SpeedrunnerModClient.clOptions().panorama = currentPanorama;
    }
}