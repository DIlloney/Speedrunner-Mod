...
public class CommonOresScreen extends GameOptionsScreen {
    private final Screen parent;
    protected final LiteralText pageNumber = new LiteralText("§lPage:§r 4/6");

    public CommonOresScreen(Screen parent, GameOptions options) {
        super(parent, options, new TranslatableText("speedrunnermod.title.features.ores_and_worldgen.common_ores"));
        this.parent = parent;
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.common_ores.line1"), this.width / 2, SpeedrunnerModClient.QUADRUPLE_LINED_SCREEN_LINE_1, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.common_ores.line2"), this.width / 2, SpeedrunnerModClient.QUADRUPLE_LINED_SCREEN_LINE_2, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.common_ores.line3"), this.width / 2, SpeedrunnerModClient.QUADRUPLE_LINED_SCREEN_LINE_3, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.ores_and_worldgen.common_ores.line4"), this.width / 2, SpeedrunnerModClient.QUADRUPLE_LINED_SCREEN_LINE_4, 16777215);
