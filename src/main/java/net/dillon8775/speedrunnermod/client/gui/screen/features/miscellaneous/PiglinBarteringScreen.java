...
public class PiglinBarteringScreen extends GameOptionsScreen {
    private final Screen parent;
    protected final LiteralText pageNumber = new LiteralText("§lPage:§r 6/10");

    public PiglinBarteringScreen(Screen parent, GameOptions options) {
        super(parent, options, new TranslatableText("speedrunnermod.title.features.miscellaneous.piglin_bartering"));
        this.parent = parent;
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.piglin_bartering.line1"), this.width / 2, 90, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.miscellaneous.piglin_bartering.line2"), this.width / 2, 110, 16777215);
        ...
        RenderSystem.setShaderTexture(0, new Identifier("speedrunnermod:textures/gui/features/miscellaneous/piglin_bartering.png"));
