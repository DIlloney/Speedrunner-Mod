...
public class ResetOptionsConfirmScreen extends GameOptionsScreen {
    ...
    private static void resetOptions() {
        ...
        SpeedrunnerMod.options().advanced.allowBoatsInLava = true;
        SpeedrunnerMod.options().advanced.allowWaterInNether = true;
        ...
        SpeedrunnerMod.options().advanced.mobSpawnerMinimumSpawnDuration = 20;
        ...
        SpeedrunnerMod.options().advanced.globalNetherPortals = false;
        ...
        SpeedrunnerModClient.clientOptions().itemMessages = ClientModOptions.ItemMessages.ACTIONBAR;
