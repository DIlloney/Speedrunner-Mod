...
public class ModMenuScreen extends GameOptionsScreen {
    ...
    private ButtonWidget featuresButton;
    ...
    protected void init() {
        ...
        featuresButton = this.addDrawableChild(new ButtonWidget(rightSide, height, 150, 20, new TranslatableText("speedrunnermod.menu.features"), (button) -> {
            this.client.setScreen(new FeaturesScreen(this, MinecraftClient.getInstance().options));
        }, (button, matrices, x, y) -> this.renderTooltip(matrices, new TranslatableText("speedrunnermod.menu.features.coming_soon"), x, y)));
        featuresButton.active = false;
