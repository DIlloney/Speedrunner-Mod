...
public class SpeedrunnerNuggetsScreen extends GameOptionsScreen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.blocks_and_items.speedrunner_nuggets.line1"), this.width / 2, 90, 16777215);
        drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.features.blocks_and_items.speedrunner_nuggets.line2"), this.width / 2, 110, 16777215);
        ...
        RenderSystem.setShaderTexture(0, new Identifier("speedrunnermod:textures/gui/features/blocks_and_items/speedrunner_nuggets.png"));
