...
public class ModBlockTags {
    ...
    public static Tag.Identified<Block> SPEEDRUNNER_FUELS = TagFactory.BLOCK.create(new Identifier(SpeedrunnerMod.MOD_ID, "speedrunner_fuels"));
    public static Tag.Identified<Block> BARTERING_ITEMS = TagFactory.BLOCK.create(new Identifier(SpeedrunnerMod.MOD_ID, "bartering_items"));
