...
public class Leaderboards {
    ...
    private static void addIneligible(String translation, Object... args) {
        TranslatableText baseText = new TranslatableText("speedrunnermod.leaderboards.ineligible_options." + translation, args);
    ...
    private static Text withFormatting(String optionString, Formatting... formatting) {
        return new TranslatableText(optionString).formatted(formatting);
    }
    ...
    private static Text withFormatting(int intOption, Formatting... formatting) {
        return new TranslatableText(String.valueOf(intOption)).formatted(formatting);
    }
