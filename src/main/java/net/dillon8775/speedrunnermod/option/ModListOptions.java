...
public class ModListOptions {
    ...
    public static final SimpleOption<Boolean> CUSTOM_BIOMES_AND_CUSTOM_BIOME_FEATURES = new SimpleOption<>("speedrunnermod.options.custom_biomes", SimpleOption.constantTooltip(Text.translatable("speedrunnermod.options.custom_biomes.tooltip")),
            (optionText, value) -> !value ? ModTexts.OFF : ModTexts.ON, SimpleOption.BOOLEAN, options().main.customBiomes, value -> options().main.customBiomes = value);
