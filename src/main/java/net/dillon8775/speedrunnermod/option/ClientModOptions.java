...
public class ClientModOptions {
    ...
    public enum Panorama {
        ...
        DEFAULT(6, "speedrunnermod.options.panorama.default");
    ...
    private static void safeCheck() {
        ...
        if (SpeedrunnerModClient.clientOptions().panorama == Panorama.SPEEDRUNNER_MOD ||
                SpeedrunnerModClient.clientOptions().panorama == Panorama.EASIER_SPEEDRUNNING ||
        ...
        if (SpeedrunnerModClient.clientOptions().gameMode == GameMode.SURVIVAL ||
                SpeedrunnerModClient.clientOptions().gameMode == GameMode.CREATIVE ||
                SpeedrunnerModClient.clientOptions().gameMode == GameMode.SPECTATOR ||
                SpeedrunnerModClient.clientOptions().gameMode == GameMode.HARDCORE) {
            doNothing();
        } else {
        ...
        if (SpeedrunnerModClient.clientOptions().difficulty == Difficulty.PEACEFUL ||
                SpeedrunnerModClient.clientOptions().difficulty == Difficulty.EASY ||
                SpeedrunnerModClient.clientOptions().difficulty == Difficulty.NORMAL ||
                SpeedrunnerModClient.clientOptions().difficulty == Difficulty.HARD) {
            doNothing();
        } else {
