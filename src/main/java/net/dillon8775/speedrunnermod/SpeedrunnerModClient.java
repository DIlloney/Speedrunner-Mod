...
public class SpeedrunnerModClient implements ClientModInitializer {
     ...
     * <p>Instant World Creation settings and function, <i>along with</i> the {@link net.dillon8775.speedrunnermod.option.CLModOptions.ModButtonType} configuration <i>and</i> the social buttons option</p>
     * <p></p>
