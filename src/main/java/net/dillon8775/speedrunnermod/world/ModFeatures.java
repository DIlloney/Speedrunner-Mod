...
public class ModFeatures {
    ...
    public static void makeAnimalsMoreCommon(SpawnSettings.Builder builder) {
        switch (SpeedrunnerMod.options().mobSpawningRate) {
            case LOW:
    ...
    static {
        NETHER_FORTRESS_MOB_SPAWNS = SpeedrunnerMod.options().doomMode ?
                Pool.of(
        ...
        STRONGHOLD_GENERATION = SpeedrunnerMod.options().doomMode ? new StrongholdGenerator.PieceData[]{
                ...
                new StrongholdGenerator.PieceData(StrongholdGenerator.Library.class, 100, SpeedrunnerMod.options().strongholdLibraryCount * 2) {
            ...
            public boolean canGenerate(int chainLength) {
                ...
                new StrongholdGenerator.PieceData(StrongholdGenerator.PortalRoom.class, 200, SpeedrunnerMod.options().strongholdPortalRoomCount) {
            public boolean canGenerate(int chainLength) {
                return super.canGenerate(chainLength);
            }
        }, new StrongholdGenerator.PieceData(StrongholdGenerator.Library.class, 200, SpeedrunnerMod.options().strongholdLibraryCount) {
            public boolean canGenerate(int chainLength) {
                return super.canGenerate(chainLength);
            }
        }};
    ...
    public static void init() {
        if (SpeedrunnerMod.options().doomMode) {
            if (SpeedrunnerMod.options().strongholdLibraryCount > 5) {
                SpeedrunnerMod.options().strongholdLibraryCount = 5;
