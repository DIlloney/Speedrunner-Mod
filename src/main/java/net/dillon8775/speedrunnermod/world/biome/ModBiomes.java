...
/**
 * <p>See {@link net.dillon8775.speedrunnermod.mixin.ModMixins.VanillaBiomeParametersMixin} for more. </p>
 * <p></p>
 * See {@link net.dillon8775.speedrunnermod.mixin.ModMixins.ConfiguredStructureFeaturesMixin} for structure generation.
 */
public class ModBiomes {
    public static final RegistryKey<Biome> SPEEDRUNNERS_WASTELAND_KEY = RegistryKey.of(Registry.BIOME_KEY, new Identifier(SpeedrunnerMod.MOD_ID, "speedrunners_wasteland"));
