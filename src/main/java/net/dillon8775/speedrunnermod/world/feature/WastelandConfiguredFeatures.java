...
public class WastelandConfiguredFeatures {
    ...
    protected static final ConfiguredFeature<?, ?> ORE_EXPERIENCE = ConfiguredFeatures.register("ore_experience_speedrunners_wasteland",
            Feature.ORE.configure(new OreFeatureConfig(ModConfiguredFeatures.EXPERIENCE_ORES, 3, 0.2f)));
