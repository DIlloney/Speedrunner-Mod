...
public class ModBlocks {
    ...
    public static final Block SPEEDRUNNER_BUTTON = new WoodenButtonBlock(FabricBlockSettings.of(ModMaterials.SPEEDRUNNER_WOOD)
            ...
            .noCollision()
            .sounds(BlockSoundGroup.WOOD));
    public static final Block SPEEDRUNNER_PRESSURE_PLATE = new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(ModMaterials.SPEEDRUNNER_WOOD)
            .strength(0.35F)
            .noCollision()
            .sounds(BlockSoundGroup.WOOD));
