        ...
        map.put(VillagerProfession.CARTOGRAPHER, TradeOffers.copyToFastUtilMap(
                ImmutableMap.of(
                        ...
                        2, new TradeOffers.Factory[]{
                                ...
                                new TradeOffers.SellMapFactory(2, ConfiguredStructureFeatureTags.ON_OCEAN_EXPLORER_MAPS, "filled_map.monument", MapIcon.Type.MONUMENT, 12, 5)},
                        3, new TradeOffers.Factory[]{new TradeOffers.BuyForOneEmeraldFactory(Items.COMPASS, 1, 12, 20),
                                new TradeOffers.SellMapFactory(3, ConfiguredStructureFeatureTags.ON_WOODLAND_EXPLORER_MAPS, "filled_map.mansion", MapIcon.Type.MANSION, 12, 10),
