...
public abstract class StrongholdSpawning extends MarginedStructureFeature<DefaultFeatureConfig> {

    public StrongholdSpawning(Codec<DefaultFeatureConfig> codec, StructureGeneratorFactory<DefaultFeatureConfig> structureGeneratorFactory) {
