...
public abstract class MobSpawnerSpawnDuration {
    @Shadow
    private int minSpawnDelay = SpeedrunnerMod.options().advanced.mobSpawnerMinimumSpawnDuration * 10;
    @Shadow
    private int maxSpawnDelay = SpeedrunnerMod.options().advanced.mobSpawnerMaximumSpawnDuration * 10;
}