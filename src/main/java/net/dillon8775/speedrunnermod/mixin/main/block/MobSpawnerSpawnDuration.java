...
public abstract class MobSpawnerSpawnDuration {
    ...
    int minSpawnDelayMixin = SpeedrunnerMod.options().advanced.mobSpawnerMinimumSpawnDuration * 10;
    int maxSpawnDelayMixin = SpeedrunnerMod.options().advanced.mobSpawnerMaximumSpawnDuration * 10;
