...
public class OrePlacedFeaturesMixin {
    ...
    static {
        if (SpeedrunnerMod.options().commonOres) {
            ORE_DIAMOND = PlacedFeatures.register("ore_diamond_" + SpeedrunnerMod.MOD_ID, OreConfiguredFeatures.ORE_DIAMOND_SMALL, CountPlacementModifier.of(4), HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(-80), YOffset.aboveBottom(80)));
            ...
            ORE_DIAMOND_BURIED = PlacedFeatures.register("ore_diamond_buried_" + SpeedrunnerMod.MOD_ID, OreConfiguredFeatures.ORE_DIAMOND_BURIED, CountPlacementModifier.of(4), HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(-80), YOffset.aboveBottom(80)));
