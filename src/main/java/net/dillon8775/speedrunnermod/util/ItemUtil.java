...
public class ItemUtil {
    ...
    public static void findStructureAndShoot(World world, PlayerEntity player, ItemStack itemstack, String structureChoice, Hand hand, TagKey<ConfiguredStructureFeature<?, ?>> type) {
