...
public class ModItemGroups {
    ...
    public static final ItemGroup SPEEDRUNNER_MOD = FabricItemGroupBuilder.create(
            ...
            .appendItems(item -> {
                ...
                item.add(new ItemStack(ModItems.SPEEDRUNNER_CHEST_BOAT));
                item.add(new ItemStack(ModItems.CRIMSON_BOAT));
                item.add(new ItemStack(ModItems.CRIMSON_CHEST_BOAT));
                item.add(new ItemStack(ModItems.WARPED_BOAT));
                item.add(new ItemStack(ModItems.WARPED_CHEST_BOAT));
                for (int i = 1; i < 7; i++) {
