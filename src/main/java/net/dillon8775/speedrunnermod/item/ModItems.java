...
public class ModItems {
    ...
    public static final Item SPEEDRUNNER_STICK = new Item(
            new Item.Settings().group(ItemGroup.MATERIALS));
    public static final Item SPEEDRUNNER_BOAT = new SpeedrunnerBoatItem(ModEntityTypes.SPEEDRUNNER_BOAT, true, new Item.Settings());
    public static final Item CRIMSON_BOAT = new SpeedrunnerBoatItem(ModEntityTypes.CRIMSON_BOAT, false, new Item.Settings());
    public static final Item WARPED_BOAT = new SpeedrunnerBoatItem(ModEntityTypes.WARPED_BOAT, false, new Item.Settings());
    ...
    public static void clinit() {
        FabricModelPredicateProviderRegistry.register(SPEEDRUNNER_BOW.asItem(), new Identifier("pull"), (stack, world, entity, seed) -> {
            if (entity == null) {
                ...
                return entity.getActiveItem() != stack ? 0.0F : (float)(stack.getMaxUseTime() - entity.getItemUseTimeLeft()) / 15.0F;
            }
        });
