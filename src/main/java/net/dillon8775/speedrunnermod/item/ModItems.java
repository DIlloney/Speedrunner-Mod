...
public class ModItems {
    ...
    public static final Item SPEEDRUNNER_BOAT = new LavaBoatItem(
            ModEntityTypes.SPEEDRUNNER_BOAT, new Item.Settings().maxCount(1).fireproof().group(ModItemGroup.SPEEDRUNNER_MOD).group(ItemGroup.TRANSPORTATION));
    public static final Item CRIMSON_BOAT = new LavaBoatItem(
            ModEntityTypes.CRIMSON_BOAT, new Item.Settings().maxCount(1).fireproof().group(ModItemGroup.SPEEDRUNNER_MOD).group(ItemGroup.TRANSPORTATION));
    public static final Item WARPED_BOAT = new LavaBoatItem(
            ModEntityTypes.WARPED_BOAT, new Item.Settings().maxCount(1).fireproof().group(ModItemGroup.SPEEDRUNNER_MOD).group(ItemGroup.TRANSPORTATION));
    public static final Item WITHER_BONE = new Item(
            new Item.Settings().group(ModItemGroup.SPEEDRUNNER_MOD).group(ItemGroup.MISC));
    public static final Item WITHER_SWORD = new SwordItem(
            ModToolMaterials.WITHER_SWORD, 3, -2.4F,
            new Item.Settings().group(ModItemGroup.SPEEDRUNNER_MOD).group(ItemGroup.COMBAT)) {
        ...
        public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
            if (SpeedrunnerModClient.clientOptions().itemTooltips) {
                ...
                tooltip.add(new TranslatableText("item.speedrunnermod.wither_sword.tooltip.line3"));
            }
        }
    };
    ...
    public static void clinit() {
        FabricModelPredicateProviderRegistry.register(SPEEDRUNNER_BOW.asItem(), new Identifier("pull"), (stack, world, entity, seed) -> {
            if (entity == null) {
                return 0.0F;
            } else {
        ...
        FabricModelPredicateProviderRegistry.register(SPEEDRUNNER_BOW.asItem(), new Identifier("pulling"), (stack, world, entity, seed) -> {
            return entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0F : 0.0F;
        });

        FabricModelPredicateProviderRegistry.register(SPEEDRUNNER_CROSSBOW.asItem(), new Identifier("pull"), (stack, world, entity, seed) -> {
            if (entity == null) {
                return 0.0F;
            } else {
        ...
        FabricModelPredicateProviderRegistry.register(SPEEDRUNNER_CROSSBOW.asItem(), new Identifier("pulling"), (stack, world, entity, seed) -> {
            return entity != null && entity.isUsingItem() && entity.getActiveItem() == stack && !SpeedrunnerCrossbowItem.isCharged(stack) ? 1.0F : 0.0F;
        });

        FabricModelPredicateProviderRegistry.register(SPEEDRUNNER_CROSSBOW.asItem(), new Identifier("charged"), (stack, world, entity, seed) -> {
            return entity != null && SpeedrunnerCrossbowItem.isCharged(stack) ? 1.0F : 0.0F;
        });

        FabricModelPredicateProviderRegistry.register(SPEEDRUNNER_CROSSBOW.asItem(), new Identifier("firework"), (stack, world, entity, seed) -> {
        ...
        FabricModelPredicateProviderRegistry.register(SPEEDRUNNER_SHIELD, new Identifier("blocking"), (stack, world, entity, seed) -> {
            return entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0F : 0.0F;
        });
