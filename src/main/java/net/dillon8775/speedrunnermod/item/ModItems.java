...
public class ModItems {
    ...
    public static void init() {
        ...
        Registry.register(Registry.ITEM, new Identifier(SpeedrunnerMod.MOD_ID, "speedrunner_chest_boat"), SPEEDRUNNER_CHEST_BOAT);
        Registry.register(Registry.ITEM, new Identifier(SpeedrunnerMod.MOD_ID, "crimson_boat"), CRIMSON_BOAT);
        Registry.register(Registry.ITEM, new Identifier(SpeedrunnerMod.MOD_ID, "crimson_chest_boat"), CRIMSON_CHEST_BOAT);
        Registry.register(Registry.ITEM, new Identifier(SpeedrunnerMod.MOD_ID, "warped_boat"), WARPED_BOAT);
        Registry.register(Registry.ITEM, new Identifier(SpeedrunnerMod.MOD_ID, "warped_chest_boat"), WARPED_CHEST_BOAT);
