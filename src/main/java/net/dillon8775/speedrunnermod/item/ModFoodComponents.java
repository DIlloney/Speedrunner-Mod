...
public class ModFoodComponents {
    ...
    static {
        ...
        PIGLIN_PORK = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(4).saturationModifier(0.3F).build() : new FoodComponent.Builder().hunger(3).saturationModifier(0.2F).build();
        COOKED_PIGLIN_PORK = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.7F).build();
        GOLDEN_PIGLIN_PORK = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(8).saturationModifier(0.9F).build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).build();
        GOLDEN_BEEF = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(8).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.9F).meat().build();
        GOLDEN_PORKCHOP = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(8).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.9F).meat().build();
        GOLDEN_MUTTON = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(6).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.9F).meat().build();
        GOLDEN_CHICKEN = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(6).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.7F).meat().build();
        GOLDEN_RABBIT = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(5).saturationModifier(1.2F).meat().build() : new FoodComponent.Builder().hunger(5).saturationModifier(0.7F).meat().build();
        GOLDEN_COD = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(5).saturationModifier(1.2F).meat().build() : new FoodComponent.Builder().hunger(5).saturationModifier(0.7F).meat().build();
        GOLDEN_SALMON = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(6).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(6).saturationModifier(0.9F).meat().build();
        GOLDEN_BREAD = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(5).saturationModifier(1.2F).meat().build() : new FoodComponent.Builder().hunger(5).saturationModifier(0.7F).meat().build();
        GOLDEN_POTATO = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(6).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(5).saturationModifier(0.7F).meat().build();
        GOLDEN_BEETROOT = SpeedrunnerMod.options().betterFoods ? new FoodComponent.Builder().hunger(2).saturationModifier(1.5F).meat().build() : new FoodComponent.Builder().hunger(2).saturationModifier(0.7F).meat().build();
