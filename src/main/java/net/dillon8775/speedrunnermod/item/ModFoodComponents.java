...
public class ModFoodComponents {
    ...
    static {
        ...
        PIGLIN_PORK = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(4).saturationModifier(0.3F).build() : new FoodComponent.Builder().hunger(3).saturationModifier(0.2F).build();
        COOKED_PIGLIN_PORK = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.7F).build();
        GOLDEN_PIGLIN_PORK = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(8).saturationModifier(0.9F).build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).build();
        GOLDEN_BEEF = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(8).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.9F).meat().build();
        GOLDEN_PORKCHOP = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(8).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.9F).meat().build();
        GOLDEN_MUTTON = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(6).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.9F).meat().build();
        GOLDEN_CHICKEN = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(6).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(8).saturationModifier(0.7F).meat().build();
        GOLDEN_RABBIT = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(5).saturationModifier(1.2F).meat().build() : new FoodComponent.Builder().hunger(5).saturationModifier(0.7F).meat().build();
        GOLDEN_COD = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(5).saturationModifier(1.2F).meat().build() : new FoodComponent.Builder().hunger(5).saturationModifier(0.7F).meat().build();
        GOLDEN_SALMON = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(6).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(6).saturationModifier(0.9F).meat().build();
        GOLDEN_BREAD = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(5).saturationModifier(1.2F).meat().build() : new FoodComponent.Builder().hunger(5).saturationModifier(0.7F).meat().build();
        GOLDEN_POTATO = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(6).saturationModifier(1.0F).meat().build() : new FoodComponent.Builder().hunger(5).saturationModifier(0.7F).meat().build();
        GOLDEN_BEETROOT = SpeedrunnerMod.options().main.betterFoods ? new FoodComponent.Builder().hunger(2).saturationModifier(1.5F).meat().build() : new FoodComponent.Builder().hunger(2).saturationModifier(0.7F).meat().build();
        ...
        ENCHANTED_GOLDEN_APPLE = new FoodComponent.Builder().hunger(8).saturationModifier(1.4F).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 600, 1), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 6000, 0), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 6000, 0), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 2400, 3), 1.0F).alwaysEdible().build();
        GOLDEN_APPLE = new FoodComponent.Builder().hunger(8).saturationModifier(1.3F).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 200, 2), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 2400, 0), 1.0F).alwaysEdible().build();
