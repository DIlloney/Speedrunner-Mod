...
public class ModItemGroup {
    public static final ItemGroup SPEEDRUNNER_MOD = FabricItemGroupBuilder.create(
            ...
            .appendItems(itemStacks -> {
                ...
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_LOG));
                itemStacks.add(new ItemStack(ModItems.STRIPPED_SPEEDRUNNER_LOG));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_WOOD));
                itemStacks.add(new ItemStack(ModItems.STRIPPED_SPEEDRUNNER_WOOD));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_LEAVES));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_SAPLING));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_PLANKS));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_STICK));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_SLAB));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_STAIRS));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_FENCE));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_FENCE_GATE));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_TRAPDOOR));
                itemStacks.add(new ItemStack(ModItems.REINFORCED_SPEEDRUNNER_TRAPDOOR));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_BUTTON));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_PRESSURE_PLATE));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_WEIGHTED_PRESSURE_PLATE));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_DOOR));
                itemStacks.add(new ItemStack(ModItems.REINFORCED_SPEEDRUNNER_DOOR));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNER_SIGN));
                itemStacks.add(new ItemStack(ModItems.SPEEDRUNNERS_WORKBENCH));
                itemStacks.add(new ItemStack(ModItems.DEAD_SPEEDRUNNER_BUSH));
