...
/**
 * The {@link net.dillon8775.speedrunnermod.SpeedrunnerMod} crossbow, which charges faster, shoots farther, and has more durability.
 */
public class SpeedrunnerCrossbowItem extends CrossbowItem {

    public SpeedrunnerCrossbowItem(Settings settings) {
        super(settings.group(ItemGroup.COMBAT).maxCount(1).maxDamage(652));
    }
