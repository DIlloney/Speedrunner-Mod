    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (world instanceof ServerWorld) {
            ...
            if (blockPos != null) {
                ...
                player.sendMessage(new TranslatableText("item.speedrunnermod.eye_of_annul.blocks_away", structureType, structureDistance).formatted(CLModOptions.isActionbar() ? Formatting.LIGHT_PURPLE : Formatting.WHITE), CLModOptions.isActionbar());
