...
public class SpeedrunnersEyeItem extends Item {
        ...
        if (!world.isClient) {
            if (world.getRegistryKey() == World.OVERWORLD) {
                if (player.isSneaking()) {
                    ...
                    player.sendMessage(new TranslatableText("item.speedrunnermod.speedrunners_eye.looking_for", structureType).formatted(ItemUtil.toFormatting(Formatting.AQUA, Formatting.WHITE)), ModOptions.ItemMessages.isActionbar());
                } else {
                    ...
                    player.sendMessage(new TranslatableText("item.speedrunnermod.speedrunners_eye.blocks_away", structureType, structureDistance).formatted(ItemUtil.toFormatting(Formatting.AQUA, Formatting.WHITE)), ModOptions.ItemMessages.isActionbar());
                ...
                player.sendMessage(new TranslatableText("item.speedrunnermod.speedrunners_eye.wrong_dimension").formatted(ItemUtil.toFormatting(Formatting.AQUA, Formatting.WHITE)), ModOptions.ItemMessages.isActionbar());
            }
        }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(new TranslatableText("item.speedrunnermod.speedrunners_eye.looking_for.tooltip", structureType).formatted(Formatting.BOLD));
    }
}