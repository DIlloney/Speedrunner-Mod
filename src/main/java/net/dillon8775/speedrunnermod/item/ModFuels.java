...
public class ModFuels {
    ...
    public static void init() {
        ...
        registry.add(ModBlocks.DEAD_SPEEDRUNNER_LOG, 400);
        registry.add(ModBlocks.DEAD_STRIPPED_SPEEDRUNNER_LOG, 400);
        registry.add(ModBlocks.DEAD_SPEEDRUNNER_WOOD, 400);
        registry.add(ModBlocks.DEAD_STRIPPED_SPEEDRUNNER_WOOD, 400);
        ...
        registry.add(ModBlocks.WOODEN_SPEEDRUNNER_PRESSURE_PLATE, 400);
