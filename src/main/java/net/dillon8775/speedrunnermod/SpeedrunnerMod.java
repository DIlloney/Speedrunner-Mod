...
public class SpeedrunnerMod implements ModInitializer {
    ...
    public static final String MOD_VERSION = "v1.8.2";
     ...
     * <p>This does not include {@link org.spongepowered.asm.mixin.Mixins}</p>
     */
    public void onInitialize() {
        ...
        LOGGER.info("The Speedrunner Mod (" + MOD_VERSION + ")" + " has successfully initialized!");
    }
