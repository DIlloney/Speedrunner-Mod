...
public class SpeedrunnerSwordItem extends SwordItem {
    ...
    public SpeedrunnerSwordItem(int attackDamage, boolean golden, Settings settings) {
        super(!golden ? ModToolMaterials.SPEEDRUNNER_SWORD_PICKAXE : ModToolMaterials.GOLDEN_SPEEDRUNNER, settings.attributeModifiers(SwordItem.createAttributeModifiers(!golden ? ModToolMaterials.SPEEDRUNNER_SWORD_PICKAXE : ModToolMaterials.GOLDEN_SPEEDRUNNER, attackDamage, -2.4F)));
