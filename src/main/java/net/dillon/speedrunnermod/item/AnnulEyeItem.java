...
public class AnnulEyeItem extends Item {
    ...
    private BlockPos findEndPortalFrame(World world, BlockPos strongholdPos) {
        for (BlockPos pos : BlockPos.iterate(strongholdPos.add(options().advanced.annulEyePortalRoomDistanceXYZ.getAtIndex(0), options().advanced.annulEyePortalRoomDistanceXYZ.getAtIndex(1), options().advanced.annulEyePortalRoomDistanceXYZ.getAtIndex(2)), strongholdPos.add(options().advanced.annulEyePortalRoomDistanceXYZ.getAtIndex(3), options().advanced.annulEyePortalRoomDistanceXYZ.getAtIndex(4), options().advanced.annulEyePortalRoomDistanceXYZ.getAtIndex(5)))) {
