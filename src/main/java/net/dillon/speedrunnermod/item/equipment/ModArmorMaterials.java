...
public interface ModArmorMaterials {
    ...
    }), 16, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0.0F, ModItemTags.SPEEDRUNNER_TOOL_MATERIALS, ModEquipmentAssetKeys.SPEEDRUNNER);
    ArmorMaterial GOLDEN_SPEEDRUNNER = new ArmorMaterial(11, Util.make(new EnumMap<>(EquipmentType.class), map -> {
        ...
        map.put(EquipmentType.BOOTS, 2);
        map.put(EquipmentType.BODY, 8);
    }), 27, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F, 0.0F, ModItemTags.GOLDEN_SPEEDRUNNER_TOOL_MATERIALS, ModEquipmentAssetKeys.GOLDEN_SPEEDRUNNER);
}