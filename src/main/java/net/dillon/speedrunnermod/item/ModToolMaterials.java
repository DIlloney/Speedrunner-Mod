...
public class ModToolMaterials {
    ...
    public static final ToolMaterial SPEEDRUNNER_SWORD_PICKAXE = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 131, 4.0F, 1.0F, 5, ModItemTags.SPEEDRUNNER_TOOL_MATERIALS);
