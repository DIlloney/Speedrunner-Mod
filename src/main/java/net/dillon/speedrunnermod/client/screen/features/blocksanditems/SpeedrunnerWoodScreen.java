...
public class SpeedrunnerWoodScreen extends AbstractFeatureScreen {
    ...
    public SpeedrunnerWoodScreen(Screen parent, GameOptions options) {
        super(parent, options, Text.translatable("speedrunnermod.title.features.blocks_and_items.speedrunner_wood"), true, false);
    }
    ...
    protected Identifier getImage() {
        return Identifier.of(SpeedrunnerMod.MOD_ID, "textures/gui/features/blocks/speedrunner_wood.png");
    }
