...
public class EndScreen extends AbstractFeatureScreen {
    ...
    protected void renderCustomImage(DrawContext context) {
        context.drawTexture(new Identifier(SpeedrunnerMod.MOD_ID, "textures/gui/logo.png"), this.width / 2, 215, 0, 0, this.getImageWidth(), this.getImageHeight(), this.getImageWidth(), this.getImageHeight());
    }
