...
public class MoreBoatsScreen extends AbstractFeatureScreen {
    ...
    protected void renderCustomImage(DrawContext context) {
        context.drawTexture(ofSpeedrunnerMod("textures/gui/features/other/more_boats.png"), this.width / 2, 200, 0.0F, 0.0F, this.getImageWidth(), this.getImageHeight(), this.getImageWidth(), this.getImageHeight());
    }
