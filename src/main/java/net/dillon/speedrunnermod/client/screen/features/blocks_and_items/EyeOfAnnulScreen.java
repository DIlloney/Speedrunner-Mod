...
public class EyeOfAnnulScreen extends AbstractFeatureScreen {
    ...
    protected Identifier getImage() {
        return new Identifier(SpeedrunnerMod.MOD_ID, "textures/gui/features/items/eye_of_annul.png");
    }
    ...
    protected Identifier getCraftingRecipeImage() {
        return new Identifier(SpeedrunnerMod.MOD_ID, "textures/gui/features/recipes/eye_of_annul_crafting_recipe.png");
    }
