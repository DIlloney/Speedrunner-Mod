...
public class EyeOfAnnulScreen extends AbstractFeatureScreen {
    ...
    protected Identifier getImage() {
        return Identifier.of(SpeedrunnerMod.MOD_ID, "textures/gui/features/items/eye_of_annul.png");
    }
    ...
    protected Identifier getCraftingRecipeImage() {
        return Identifier.of(SpeedrunnerMod.MOD_ID, "textures/gui/features/recipes/eye_of_annul_crafting_recipe.png");
    }
