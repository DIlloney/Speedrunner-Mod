...
public class FortressesBastionsAndStrongholdsScreen extends AbstractFeatureScreen {
    ...
    public FortressesBastionsAndStrongholdsScreen(Screen parent, GameOptions options) {
        super(parent, options, new TranslatableText("speedrunnermod.title.features.ores_and_worldgen.fortresses_bastions_and_strongholds").formatted(Formatting.RED), 7, false, false, new ResetKeyScreen(parent, options), new TranslatableText("speedrunnermod.menu.features.miscellaneous"), new SpeedrunnerIngotsScreen(parent, options), new TranslatableText("speedrunnermod.menu.features.blocks_and_items"), new SpeedrunnerArmorScreen(parent, options), new TranslatableText("speedrunnermod.menu.features.tools_and_armor"), false, null, null);
    }
