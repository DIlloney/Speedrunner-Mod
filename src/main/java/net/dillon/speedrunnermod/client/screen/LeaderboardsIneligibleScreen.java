...
public class LeaderboardsIneligibleScreen extends AbstractModScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(this.getButtonsLeftSide(), this.getButtonsHeight(), 100, 20, needsRestartFromEnablingLeaderboardsMode ? ModTexts.RESTART_NOW : Leaderboards.noOptionsWereChanged() ? ModTexts.FIX_AND_RESTART : ModTexts.REVERT_CHANGES, (buttonWidget) -> {
            ...
            if (needsRestartFromEnablingLeaderboardsMode) {
                this.renderOrderedTooltip(matrices, this.client.textRenderer.wrapLines(new TranslatableText("speedrunnermod.restart_now.tooltip"), 200), x, y);
            } else if (Leaderboards.noOptionsWereChanged()) {
                this.renderOrderedTooltip(matrices, this.client.textRenderer.wrapLines(new TranslatableText("speedrunnermod.fix_and_restart.tooltip"), 200), x, y);
            } else {
                this.renderOrderedTooltip(matrices, this.client.textRenderer.wrapLines(new TranslatableText("speedrunnermod.revert_changes.tooltip"), 200), x, y);
            }
        }));
        this.addDrawableChild(new ButtonWidget(this.getButtonsMiddle(), this.getButtonsHeight(), 100, 20, needsRestartFromEnablingLeaderboardsMode ? ModTexts.REVERT_CHANGES : ModTexts.DISABLE_LEADERBOARDS_MODE_AND_RESTART, (buttonWidget) -> {
            ...
            if (!needsRestartFromEnablingLeaderboardsMode) {
                this.renderOrderedTooltip(matrices, this.client.textRenderer.wrapLines(new TranslatableText("speedrunnermod.disable_leaderboards_mode_and_restart.tooltip"), 200), x, y);
            }
        }));
        this.addDrawableChild(new ButtonWidget(this.getButtonsRightSide(), this.getButtonsHeight(), 100, 20, ModTexts.IGNORE, (buttonWidget) -> {
            ...
            if (!needsRestartFromEnablingLeaderboardsMode) {
                this.renderOrderedTooltip(matrices, this.client.textRenderer.wrapLines(new TranslatableText("speedrunnermod.ignore.tooltip"), 200), x, y);
            } else {
                this.renderOrderedTooltip(matrices, this.client.textRenderer.wrapLines(new TranslatableText("speedrunnermod.ignore_restart.tooltip"), 200), x, y);
            }
        }));
    ...
    public void renderCustomText(MatrixStack matrices) {
        if (needsRestartFromEnablingLeaderboardsMode) {
            drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.restart_required.line1"), this.width / 2, 110, 16777215);
            drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.restart_required.line2"), this.width / 2, 130, 16777215);
        } else if (Leaderboards.noOptionsWereChanged()) {
            drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.restart.line1"), this.width / 2, 80, 16777215);
            drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.restart.line2"), this.width / 2, 100, 16777215);
            drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.restart.line3"), this.width / 2, 120, 16777215);
        } else {
            drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.ineligible.line1"), this.width / 2, 80, 16777215);
            drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.ineligible.line2"), this.width / 2, 100, 16777215);
            drawCenteredText(matrices, this.textRenderer, new TranslatableText("speedrunnermod.leaderboards.ineligible_options.line3"), this.width / 2, 120, 16777215);
        }
    }
