 ...
 * Note: {@link TradeOffers.TypeAwareBuyForOneEmeraldFactory} wasn't working correctly, so I had to cast the {@link ImmutableMap#builder()} to a default {@link Map} in order for it to work.
 */
