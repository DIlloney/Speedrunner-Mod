    ...
    public static final Map<VillagerProfession, Int2ObjectMap<TradeOffers.Factory[]>> PROFESSION_TO_LEVELED_TRADE = options().main.betterVillagerTrades ? Util.make(Maps.newHashMap(), map -> {
        ...
        map.put(VillagerProfession.CARTOGRAPHER, TradeOffers.copyToFastUtilMap(
                ImmutableMap.of(
                        ...
                        2, new TradeOffers.Factory[]{
                                ...
                                new TradeOffers.SellMapFactory(2, StructureTags.ON_OCEAN_EXPLORER_MAPS, "filled_map.monument", MapIcon.Type.MONUMENT, 12, 5)},
                        3, new TradeOffers.Factory[]{new TradeOffers.BuyItemFactory(Items.COMPASS, 1, 12, 20),
                                new TradeOffers.SellMapFactory(3, StructureTags.ON_WOODLAND_EXPLORER_MAPS, "filled_map.mansion", MapIcon.Type.MANSION, 12, 10),
        ...
        map.put(VillagerProfession.CLERIC, TradeOffers.copyToFastUtilMap(
                ImmutableMap.of(
                        ...
                        4, new TradeOffers.Factory[]{new TradeOffers.BuyItemFactory(Items.SCUTE, 1, 16, 30),
        ...
        map.put(VillagerProfession.LEATHERWORKER, TradeOffers.copyToFastUtilMap(
                ImmutableMap.of(
                        ...
                        3, new TradeOffers.Factory[]{
                                ...
                                new TradeOffers.SellDyedArmorFactory(Items.LEATHER_CHESTPLATE, 1)},
                        4, new TradeOffers.Factory[]{
                                new TradeOffers.BuyItemFactory(Items.SCUTE, 1, 24, 30),
