...
public abstract class AnvilScreenHandlerMixin extends ForgingScreenHandler {
    ...
    private int countOverMaxLevel(Enchantment enchantment) {
        ...
        ItemEnchantmentsComponent itemStack2Component = EnchantmentHelper.getEnchantments(itemStack2);
        ItemEnchantmentsComponent itemStack3Component = EnchantmentHelper.getEnchantments(itemStack3);
        int getCurrentLevelAndAddOne = 0;
        for (Object2IntMap.Entry<RegistryEntry<Enchantment>> entry : itemStack2Component.getEnchantmentEntries()) {
            ...
            int q = itemStack2Component.getLevel(registryEntry);
