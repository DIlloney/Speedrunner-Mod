...
public class SpeedrunnerMod implements ModInitializer {
    ...
    public static final int[] DRY_BIOME_IDS = SpeedrunnerMod.options().main.commonBiomes ? new int[]{2, 2, 2, 35, 35, 35, 36, 1, 1, 2, 35, 35, 1, 1, 2, 35, 2, 1, 35, 35, 2} : new int[]{2, 2, 2, 35, 35, 1};
    public static final int[] TEMPERATE_BIOME_IDS = SpeedrunnerMod.options().main.commonBiomes ? new int[]{4, 29, 2, 2, 2, 1, 1, 35, 35, 2, 35, 1} : new int[]{4, 29, 3, 1, 27, 6};
    public static final int[] COOL_BIOME_IDS = SpeedrunnerMod.options().main.commonBiomes ? new int[]{4, 5, 6, 1, 2, 2, 35} : new int[]{4, 3, 5, 1};
    public static final int[] SNOWY_BIOME_IDS = SpeedrunnerMod.options().main.commonBiomes ? new int[]{12, 30, 3, 2, 1, 35, 2} : new int[]{12, 12, 12, 30};
    ...
    public static void applyBlockHardnessValues(BlockView world, BlockPos pos, CallbackInfoReturnable<Float> cir) {
        if (SpeedrunnerMod.options().main.modifyBlockHardness) {
    ...
    public static void modifyMonsters(net.minecraft.world.biome.SpawnSettings.Builder builder, int zombieWeight, int zombieVillagerWeight, int skeletonWeight) {
        if (SpeedrunnerMod.options().main.doomMode) {
