...
public class SpeedrunnerMod implements ModInitializer {
    ...
    public static void applyFallDamage(World world, BlockState state, BlockPos pos, Entity entity, float fallDistance) {
        entity.handleFallDamage(fallDistance, getFallDamageMultiplier(), DamageSource.FALL);
    }
    ...
    public static boolean fixShearingSheep(ItemStack stack) {
        return stack.isOf(Items.SHEARS) || stack.isOf(ModItems.SPEEDRUNNER_SHEARS);
    }

    public static boolean fixShearingSnowGolem(ItemStack stack) {
        return stack.isOf(Items.SHEARS) || stack.isOf(ModItems.SPEEDRUNNER_SHEARS);
    }

    public static boolean fixShields(ItemStack stack) {
    ...
    public static Biome method_21000(boolean sunflower) {
    ...
    public static boolean fixNetherPortalBaseBlocks(World world, BlockPos pos, Direction direction) {
    ...
    public static boolean fixBeehiveBlock(ItemStack stack) {
        return stack.isOf(Items.SHEARS) || stack.isOf(ModItems.SPEEDRUNNER_SHEARS);
    }

    public static boolean fixPumpkinBlock(ItemStack stack) {
        return stack.isOf(Items.SHEARS) || stack.isOf(ModItems.SPEEDRUNNER_SHEARS);
    }

    public static boolean fixTntBlock(ItemStack stack) {
        return stack.isOf(Items.FLINT_AND_STEEL) || stack.isOf(ModItems.SPEEDRUNNER_FLINT_AND_STEEL) || stack.isOf(Items.FIRE_CHARGE);
    }

    public static boolean fixTripwireBlock(ItemStack stack) {
        return stack.isOf(Items.SHEARS) || stack.isOf(ModItems.SPEEDRUNNER_SHEARS);
    }

    public static boolean fixEfficiencyEnchantment(ItemStack stack) {
        return stack.isOf(Items.SHEARS) || stack.isOf(ModItems.SPEEDRUNNER_SHEARS);
    }
