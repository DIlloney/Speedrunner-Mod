...
import net.dilloney.speedrunnermod.util.ModTradeOffers;
...
public class ModVillagers {
    public static final PointOfInterestType RETIRED_SPEEDRUNNER_POI = registerPOI("speedrunner_poi", ModBlocks.SPEEDRUNNER_BLOCK);
    ...
    public static void init() {
        ...
        TradeOfferHelper.registerVillagerOffers(RETIRED_SPEEDRUNNER, 1, factories -> {
            factories.add(new TradeOffers.SellItemFactory(Items.BOOK, 2, 3, 12, 3));
        });
        TradeOfferHelper.registerVillagerOffers(RETIRED_SPEEDRUNNER, 1, factories -> {
            factories.add(new ModTradeOffers.EnchantBookFactory(3));
        });
        ...
        TradeOfferHelper.registerVillagerOffers(RETIRED_SPEEDRUNNER, 2, factories -> {
            factories.add(new ModTradeOffers.EnchantBookFactory(5));
        });
        ...
        TradeOfferHelper.registerVillagerOffers(RETIRED_SPEEDRUNNER, 3, factories -> {
            factories.add(new ModTradeOffers.EnchantBookFactory(9));
        });
        ...
        TradeOfferHelper.registerVillagerOffers(RETIRED_SPEEDRUNNER, 5, factories -> {
            factories.add(new ModTradeOffers.MaxedEnchantBookFactory(12));
        });
        TradeOfferHelper.registerVillagerOffers(RETIRED_SPEEDRUNNER, 5, factories -> {
            factories.add(new TradeOffers.SellEnchantedToolFactory(Items.NETHERITE_CHESTPLATE, 24, 1, 20, 2));
        });
