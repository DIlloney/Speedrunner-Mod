...
public class ModOption {
    ...
    public static final CyclingOption<Boolean> FOG = CyclingOption.create("options.fog", new TranslatableText("options.fog.tooltip"), gameOptions -> SpeedrunnerMod.OPTIONS.getFog(), (gameOptions, option, newValue) -> {
