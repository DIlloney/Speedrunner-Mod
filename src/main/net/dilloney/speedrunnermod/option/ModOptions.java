...
public class ModOptions {
    ...
    public static class TimerOptions {
        ...
        public double backgroundTransparency = 0.5;
        public int backgroundColor = 0x000011;
        public int gameTimeLabelColor = 0x29DB87;
        public int realTimeLabelColor = 0x59AB87;
        public int overworldSplitColor = 0x777CFF;
        public int netherSplitColor = 0xFF5555;
        public int strongholdSplitColor = 0x99AADF;
        public int finishedSplitColor = 0xFFA500;
        public int seedColor = 0x00FF22;
        public boolean boldText = false;
        public boolean showSeed = true;
        public boolean showCompareSplits = true;
        public boolean useBestSplits = false;
        ...
        public int getGameTimeLabelColor() {
            return gameTimeLabelColor;
        }

        public int getRealTimeLabelColor() {
            return realTimeLabelColor;
        }

        public int getOverworldSplitColor() {
            return overworldSplitColor;
        }

        public int getNetherSplitColor() {
            return netherSplitColor;
        }

        public int getStrongholdSplitColor() {
            return strongholdSplitColor;
        }

        public int getFinishedSplitColor() {
            return finishedSplitColor;
        }
