...
public class ModOption {
    ...
    protected static final CyclingOption<Boolean> MODIFIED_BIOMES;
    ...
    static {
        ...
        MODIFIED_BIOMES = CyclingOption.create("options.modified_biomes", new TranslatableText("options.modified_biomes.tooltip"), gameOptions -> SpeedrunnerMod.options().advanced.modifiedBiomes, (gameOptions, option, newValue) -> SpeedrunnerMod.options().advanced.modifiedBiomes = newValue);
