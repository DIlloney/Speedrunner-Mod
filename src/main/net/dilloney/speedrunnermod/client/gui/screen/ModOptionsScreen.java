...
public class ModOptionsScreen extends GameOptionsScreen {
    private static final Option[] OPTIONS = getOptions();
    ...
    private static Option[] getOptions() {
        return new Option[]{ModOption.COMMON_STRUCTURES, ModOption.COMMON_BIOMES, ModOption.ICARUS_MODE, ModOption.INFINITY_PEARL_MODE, ModOption.FOG, ModOption.GAMMA, ModOption.TIMER, ModOption.DOOM_MODE, ModOption.MODIFY_BLOCK_HARDNESS, ModOption.KILL_GHAST_UPON_FIREBALL, ModOption.STRONGHOLD_COUNT, ModOption.DRAGON_PERCH_TIME, ModOption.AUTO_CREATE_WORLD, ModOption.WORLD_DIFFICULTY};
    }
}