...
class LeaderboardsScreen extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(leftSide, height, 310, 20, new TranslatableText("speedrunnermod.official_leaderboards_page"), (buttonWidget) -> {
            ...
            }, LEADERBOARDS_PAGE_LINK, true));
        }, (buttonWidget, matrixStack, i, j) -> this.renderTooltip(matrixStack, new TranslatableText("speedrunnermod.official_leaderboards_page.tooltip"), i, j)));
        height += 24;
        this.addButton(new ButtonWidget(leftSide, height, 150, 20, new TranslatableText("speedrunnermod.rules.title"), (buttonWidget) -> {
            this.client.openScreen(new ConfirmChatLinkScreen((openInBrowser) -> {
                if (openInBrowser) {
        ...
        }, (buttonWidget, matrixStack, i, j) -> this.renderTooltip(matrixStack, new TranslatableText("speedrunnermod.rules.tooltip"), i, j)));
        this.addButton(new ButtonWidget(rightSide, height, 150, 20, new TranslatableText("speedrunnermod.submit_speedrun"), (buttonWidget) -> {
            this.client.openScreen(new ConfirmChatLinkScreen((openInBrowser) -> {
                if (openInBrowser) {
                ...
                this.client.openScreen(this);
            }, SUBMIT_SPEEDRUN_LINK, true));
        }, (buttonWidget, matrixStack, i, j) -> this.renderTooltip(matrixStack, new TranslatableText("speedrunnermod.submit_speedrun.tooltip"), i, j)));
