...
public class Hud {
    ...
    public Hud(TextRenderer textRenderer, int xOffset, int yOffset) {
    ...
    private void drawBackground(int padding, int color, double transparency) {
        ...
        DrawableHelper.fill(matrixStack, xOffset - padding, yOffset - padding, xOffset + maxLen + padding, lastY + textRenderer.fontHeight + padding, alphaColor);
    }
