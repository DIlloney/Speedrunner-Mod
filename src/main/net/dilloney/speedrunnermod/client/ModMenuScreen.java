...
public class ModMenuScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(this.width / 2 + 5, 40, 150, 20, new TranslatableText("speedrunnermod.leaderboards.title"), (buttonWidget) -> {
        ...
        this.addButton(new ButtonWidget(this.width / 2 + 5, 65, 150, 20, new TranslatableText("speedrunnermod.miscellaneous.title"), (buttonWidget) -> {
            this.client.openScreen(new MiscellaneousScreen(this));
        }));
        this.addButton(new ButtonWidget(this.width / 2 - 155, 90, 150, 20, new TranslatableText("speedrunnermod.resources.title"), (buttonWidget) -> {
            this.client.openScreen(new ResourcesScreen(this));
        }));
        this.addButton(new ButtonWidget(this.width / 2 + 5, 90, 150, 20, new TranslatableText("speedrunnermod.socials.title"), (buttonWidget) -> {
            this.client.openScreen(new SocialsScreen(this));
        }));
        ButtonWidget timer = this.addButton(new ButtonWidget(this.width / 2 - 155, 115, 150, 20, new TranslatableText("speedrunnermod.timer.title"), (buttonWidget) -> {
