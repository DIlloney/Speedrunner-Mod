...
public class ModFeatures {
    public static final int[] DRY_BIOME_IDS = SpeedrunnerMod.options().main.makeBiomesMoreCommon ? new int[]{2, 2, 2, 35, 35, 35, 35, 1, 1, 2, 35, 35, 1, 1, 2, 35, 2, 1, 35, 35, 2} : new int[]{2, 2, 2, 35, 35, 1};
    ...
    public static final List<SpawnSettings.SpawnEntry> NETHER_FORTRESS_MOB_SPAWNS;
